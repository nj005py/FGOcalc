...
public class BuffData {
    ...
    public static String NP_POWER_UP = "宝具威力";
    ...
    public static String NP_POWER_UP_BE = "宝具威力前";
    ...
    public static String NP_POWER_UP_AF = "宝具威力后";
        ...
        return new ArrayList<BuffInputEntity>(){
            {
                ...
                add(new BuffInputEntity(R.drawable.np_up,NP_POWER_UP,0,1));
                //充能类
                ...
                add(new BuffInputEntity(R.drawable.np_up,NP_POWER_UP_BE,0,1));
