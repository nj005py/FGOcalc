...
public class CompassView extends View {
    ...
    //召唤阵
    private Paint summonShieldPaint;
    ...
    public CompassView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mDarkRedPaint.setColor(context.getResources().getColor(R.color.colorRed));


        mDeepGrayPaint = new Paint();
        mDeepGrayPaint.setStyle(Paint.Style.STROKE);
        mDeepGrayPaint.setAntiAlias(true);
        mDeepGrayPaint.setColor(context.getResources().getColor(R.color.colorGray));


        mLightGrayPaint = new Paint();
        mLightGrayPaint.setStyle(Paint.Style.FILL);
        mLightGrayPaint.setAntiAlias(true);
        mLightGrayPaint.setColor(context.getResources().getColor(R.color.colorLightGray));

        mTextPaint = new Paint();
        mTextPaint.setStyle(Paint.Style.STROKE);
        mTextPaint.setAntiAlias(true);
        mTextPaint.setTextSize(80);
        mTextPaint.setColor(context.getResources().getColor(R.color.colorWhite));

        mCircumPaint = new Paint();
        mCircumPaint.setStyle(Paint.Style.FILL);
        mCircumPaint.setAntiAlias(true);
        mCircumPaint.setColor(context.getResources().getColor(R.color.colorRed));

        mOutSideCircumPaint = new Paint();
        mOutSideCircumPaint.setStyle(Paint.Style.FILL);
        mOutSideCircumPaint.setAntiAlias(true);
        mOutSideCircumPaint.setColor(context.getResources().getColor(R.color.colorLightGray));
        ...
        mNorthPaint.setColor(context.getResources().getColor(R.color.colorRed));

        mOthersPaint = new Paint();
        mOthersPaint.setStyle(Paint.Style.STROKE);
        mOthersPaint.setAntiAlias(true);
        mOthersPaint.setTextSize(40);
        mOthersPaint.setColor(context.getResources().getColor(R.color.colorWhite));
        ...
        mCenterPaint.setColor(context.getResources().getColor(R.color.colorWhite));
        ...
        mSamllDegreePaint.setColor(context.getResources().getColor(R.color.colorLightGray));

        summonShieldPaint = new Paint();
        summonShieldPaint.setStyle(Paint.Style.FILL);
        summonShieldPaint.setAntiAlias(true);
//        summonShieldPaint.setColor(ContextCompat.getColor(context,android.R.color.transparent));
        ...
        mAnglePaint.setColor(context.getResources().getColor(R.color.colorRed));
...
//        drawCenterText();
    ...
    private void drawSummonShield() {
        mCanvas.save();
        Bitmap bitmap = null;
        bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.guda_round);
        if (bitmap != null) {
            ...
            matrix.postTranslate(width / 2, mOutSideRadius + mTextHeight);
            mCanvas.drawBitmap(bitmap,matrix,summonShieldPaint);
            mCanvas.restore();
        }
    }
    ...
    private void drawCompassCircum() {
        ...
        mCanvas.drawArc(rect, -85, 350, false, mDeepGrayPaint);
...
//                width / 2 + mCircumRadius, mTextHeight + mOutSideRadius + mCircumRadius, -85, 350, false, mDeepGrayPaint);
        ...
        if (val <= 180) {
            valCompare = val;
            mCanvas.drawArc(rect, -85, valCompare, false, mAnglePaint);
//            mCanvas.drawArc(width / 2 - mCircumRadius, mTextHeight + mOutSideRadius - mCircumRadius,
//                    width / 2 + mCircumRadius, mTextHeight + mOutSideRadius + mCircumRadius, -85, valCompare, false, mAnglePaint);
        } else {
            valCompare = 360 - val;
            mCanvas.drawArc(rect, -95, -valCompare, false, mAnglePaint);
//            mCanvas.drawArc(width / 2 - mCircumRadius, mTextHeight + mOutSideRadius - mCircumRadius,
//                    width / 2 + mCircumRadius, mTextHeight + mOutSideRadius + mCircumRadius, -95, -valCompare, false, mAnglePaint);
    ...
    private void drawCompassOutSide() {
        ...
        RectF rect = new RectF(0, 0, getWidth(), getHeight());
        mCanvas.drawArc(rect, -80, 120, false, mLightGrayPaint);
        mCanvas.drawArc(rect, 40, 20, false, mDeepGrayPaint);
        mCanvas.drawArc(rect, -100, -20, false, mLightGrayPaint);
        mCanvas.drawArc(rect, -120, -120, false, mDarkRedPaint);
