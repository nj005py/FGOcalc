 ...
 */
public class MetaphysicsFrag extends BaseFrag {
                ...
                if (notEmpty(etValue(fmEtId))) {
                    ...
                    if (blackPercent == -1) {
                        ...
                        if (blackPercent >= 0.85) {
                            ...
                            fmTvCharacter.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.push_left_in));
